...
const PillarReverseImageComp: React.FC<ImageCompProps> = ({ img1, img3 }) => {
  return (
    <div className="flex w-full lg:w-[660px] h-[360px] lg:h-[640px] relative rounded-2xl justify-end">
      ...
      <div className="flex flex-col h-full">
        <div className="rounded-2xl w-[180px] border-white border-8 lg:w-[360px] h-[120px] lg:h-[300px] absolute left-0 bottom-5">
          <Image
            src={img3}
            alt=""
            fill
...
export default PillarReverseImageComp;
