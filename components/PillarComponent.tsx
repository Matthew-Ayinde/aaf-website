      ...
      <div className="w-full">
        <div className="w-full hidden sm:block">
          ...
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center text-white">
            ...
            <p className="font-normal text-[18px] text-custom-gray">
        ...
        <div className="w-full sm:hidden">
          ...
          <div className="absolute top-6 mt-20 text-center text-white">
            ...
            <p className="font-normal text-sm px-9 text-custom-gray">
              With a focus on quality delivery, we are driving meaningful change
              by harnessing the power of <br /> dignity <br />
              and service to transform lives and create a more inclusive and
              equitable society
            </p>
          </div>
        </div>
