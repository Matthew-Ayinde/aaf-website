...
const SubscribeComp = () => {
  return (
    <div className="w-full flex justify-center">
      <div className="w-full lg:w-[1150px] h-[580px] lg:h-[417px] bg-[url('/subPeople.svg')] bg-[#004E7A] bg-no-repeat bg-center bg-cover rounded text-white flex flex-col justify-center items-center gap-14 px-4">
        <div className="flex flex-col gap-4 justify-center items-center text-center">
          <h1 className="font-bold text-[32px] lg:text-[40px]">
            Subscribe to our Newsletter
          </h1>
          <p className="text-base leading-[23px] lg:leading-[19px]">
