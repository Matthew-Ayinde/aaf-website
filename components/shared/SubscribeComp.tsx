...
const SubscribeComp = () => {
  return (
    <div className="w-full flex justify-center">
      <div className="w-full lg:w-[1150px] h-[580px] lg:h-[417px] bg-[url('/Subscribe-bg.png')] bg-[#004E7A] bg-no-repeat mt-10 bg-center bg-cover rounded text-white flex flex-col justify-center items-center gap-14 px-4 mx-6">
